...
exports.GROUP_COLORS = exports.SEED_PAPERS = exports.SEED_MACHINES = exports.SEED_SECTIONS = exports.SEED_SERVICES = exports.SEED_RULES_VERSION = exports.SEED_PRICING_RULES = void 0;
// ------------------------------- Pricing rules -------------------------------
exports.SEED_PRICING_RULES = [
...
exports.SEED_RULES_VERSION = {
    id: 'rules-v1',
    version: 1,
    createdAt: new Date().toISOString(),
    note: 'النسخة الأولى من قواعد الأسعار',
    rules: exports.SEED_PRICING_RULES,
};
// ------------------------------- Sections & services -------------------------
//
...
const paperOptions = [
    { id: 'pap-couche-350', label: 'ورق كوشيه 350غ', latinLabel: 'Papier Couché 350g', priceDelta: 10, deltaUnit: 'perCopy' },
    { id: 'pap-couche-300', label: 'ورق كوشيه 300غ', latinLabel: 'Papier Couché 300g', priceDelta: 8, deltaUnit: 'perCopy' },
    { id: 'pap-couche-170', label: 'ورق كوشيه 170غ', latinLabel: 'Papier Couché 170g', priceDelta: 4, deltaUnit: 'perCopy' },
...
const pelliculageOptions = [
    ...
    { id: 'pell-mat', label: 'تغليف مطفي', latinLabel: 'Pelliculage Mat', priceDelta: 0, deltaUnit: 'perCopy' },
    { id: 'pell-brillant', label: 'تغليف لامع', latinLabel: 'Pelliculage Brillant', priceDelta: 0, deltaUnit: 'perCopy' },
];
exports.SEED_SERVICES = [
    {
        id: 'svc-carte-visite',
...
exports.SEED_SECTIONS = SECTION_DEFS.map((s) => ({
    ...s,
    serviceIds: exports.SEED_SERVICES.filter((svc) => svc.sectionId === s.id).map((svc) => svc.id),
}));
// ------------------------------- Machines ------------------------------------
exports.SEED_MACHINES = [
    {
...
exports.GROUP_COLORS = ['#0D9488', '#DB2777', '#D97706', '#7C3AED', '#0284C7', '#65A30D'];
